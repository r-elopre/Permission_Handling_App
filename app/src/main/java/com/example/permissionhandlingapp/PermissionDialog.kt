...
class CameraPermissionTextProvider: PermissionTextProvider{
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
       return if (isPermanentlyDeclined){
           ...
           "This app needs access to your camera so that your friends can see you call."
       }
    }
}
...
class RecordAudioPermissionTextProvider: PermissionTextProvider{
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if (isPermanentlyDeclined){
            ...
            "This app needs access to your microphone so that your friends can see hear you."
        }
    }
}
...
class PhoneCallPermissionTextProvider: PermissionTextProvider{
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if (isPermanentlyDeclined){
            ...
            "This app needs access to your phone calling so that your friends can talk to your friends."
        }
    }
}
